        ...
        setEvents: function() {
            ...
            if(self.options.curtainLinks){
                $(self.options.curtainLinks).on('click', function(e){
                    e.preventDefault();
                    self.options.beforeLink();
                    var href = $(this).attr('href'),
                             position = null;
                    
                    if ($(href).hasClass('step')) {
                        var $step = $(href);
                        position = (self.options.mobile) ? $step.position().top + self.$elDatas[self.$current.index()]['data-position'] : $step.position().top + self.$elDatas[self.$current.index()]['data-position'];
                        // var position = self.currentHeight - self.$step.outerHeight();
                    } else{
                        position = self.$elDatas[$(href).index()]['data-position'] || null;
                    }
